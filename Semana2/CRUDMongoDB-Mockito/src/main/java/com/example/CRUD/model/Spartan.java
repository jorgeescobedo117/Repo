...
public class Spartan {
    ...
    public String getEscuadra() { return escuadra; }
    public void setEscuadra(String escuadra) { this.escuadra = escuadra; }
    ...
    public LocalDateTime getFechaAlistamiento() { return fechaAlistamiento; }
    public void setFechaAlistamiento(LocalDateTime fechaAlistamiento) { this.fechaAlistamiento = fechaAlistamiento; }
}
